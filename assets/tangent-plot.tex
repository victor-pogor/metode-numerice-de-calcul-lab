...
\begin{tikzpicture}[
	...
	\begin{axis}[
		...
		\addplot[only marks,samples at={\tonezero}]{tangent(x,\tone)}; % Punctul intersecției tangentei cu axa $x$
		...
		\addplot[only marks,samples at={\ttwozero}]{tangent(x,\ttwo)}; % Punctul intersecției tangentei cu axa $x$
